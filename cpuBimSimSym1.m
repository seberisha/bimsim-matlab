...
%         end
%         Eti = tt;
        Eti = interp1(params.r_ps(round(params.simRes/2)+1:end), E_t(round(params.simRes/2)+1:end), r_ps_2d);
        Efi = interp1(params.r_ps(round(params.simRes/2)+1:end), E_f(round(params.simRes/2)+1:end), r_ps_2d);
        Eti(isnan(Eti)) =0; Eti(isnan(Eti)) =0;
        Efi(isnan(Efi)) =0; Efi(isnan(Efi)) =0;
...
%         iftEf_d = ifft2((E_f));
        ...
        cropEf_d= iftEf_d(params.startIdx:params.endIdx,params.startIdx:params.endIdx);
