...
P_costh_ef = myLegendre(Ef_order,cos_theta);
% Legendre polynomials
P_ca1 = myLegendre(Ef_order+1, cos(alpha_1));
P_ca2= myLegendre(Ef_order+1, cos(alpha_2));
j_kr = squeeze(sphbesselj(Ef_order,kr,'multiple'));


E_f = computeEf(j_kr, P_costh_ef, P_ca1, P_ca2, E_0, Ef_order);
