function [A, B] = cpuScatteringCoefficients(material,a)
...
hl_ka_p = (derivSphHan(numOrdForMC, ka));

%evaluate the hankel functions of the first kind at ka
hl_ka = (shank1(numOrdForMC, ka, 'multiple'));
