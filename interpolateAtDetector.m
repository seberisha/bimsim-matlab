...
%     t = changeRange(filter3, 0, 1);
    ...
    gbpf = gaussianBPF((fmag)',objMinParam,objMaxParam);
...
%         params.pf(2)=params.a;
    ...
    D_Eti = interp1(params.r_ps(round(params.simRes/2)+1:end), D_Et(round(params.simRes/2)+1:end), r_ps_2d);
    D_Efi = interp1(params.r_ps(round(params.simRes/2)+1:end), D_Ef(round(params.simRes/2)+1:end), r_ps_2d);
