...
%%%%%
params.res = 32;   %spatial resolution - for symmetry this is a vector, half the size of the original x dimension of the resolution
%%%%%
...
%          params.pf
    ...
    %calculate absorbance
    A(:,:,i) = -log10((Et_d)./(Ef_d));
    imagesc(A(:,:,i)),colormap(brewer),colorbar, axis image, title(sprintf('lambda = %f',params.lambda))
